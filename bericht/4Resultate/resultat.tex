...
Der zur Verfügung stehenden Energie wird der minimale Aufwand (Sockelbetrag und Geschindigkeit) abgezogen. \todo{Gleichung einfügen}
...
\begin{minipage}{\textwidth}
\captionof{table}{Energiebilanz Bicycle Computer nach 10 s}
    \begin{tabbing}
        Geschwindigkeit \quad\= Energieabgabe EM8500\_out  \quad\= mit Sockelbeitrag STS\\[0.8ex]
        10 km/h      \> 54.4   $\mu$J        \> Rechnung = 274.9  $\mu$J\\
