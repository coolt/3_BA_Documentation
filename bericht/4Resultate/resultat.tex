...
\captionof{table}{Energieverbrauch nach Aufgaben}\label{everbrauch_aufgaben}
    ...
    Init+ Refreshen \> rot \> 91 $\mu$J \> Tabelle 3.8\\
    Start Sensor, Geschwindigkeit, Daten senden\> grau \>  49 $\mu$J    \> Tabelle 3.8\\
