...
\captionof{table}{Energieverbrauch nach Aufgaben}
    ...
    Laden C TI-SensorTag  \> violett      \> 63 $\mu$J    \> Tabelle xxx\\
    Initialisierung + Refresh-Zyklen \> rot \> 77 $\mu$J + 14 $\mu$J = 91 $\mu$J \> Tabelle xxx\\
    Start Sensor + Geschwindigkeit, Daten BLE\> grau \> 6 $\mu$J+ 43 $\mu$J = 49 $\mu$J    \> Tabelle xxx\\
