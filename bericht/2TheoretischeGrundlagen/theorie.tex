...
Neben VSUP kann der EM8500 drei weitere Ausgänge freischalten: VAUX[0] bis VAUX[2] (siehe Graphik  \ref{IOEM8500}). Vor allem aber kann per I2C oder SPI der aktuelle Spannungspegel der Regelung (VREG), der Kondensatoren (VDD_STS und VDD_LTS)und des Harvestereingangs (VDD_HRV) abgefragt werden. So kennt die Applikation jederzeit den aktuellen Energiezustand der gesammelten Energie.\\

EM8500 stellt zwei digitale Überwachungssignale zur Verfügung: Die Ausgänge BAT_LOW und HRV_LOW geben eine logische '1' aus, wenn .
Diese zwei Signale dienen der vereinfachten Energiezustandsabfrage. Die grob den Systemzustand abbildet.\\
