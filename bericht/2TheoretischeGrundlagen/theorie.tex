...
Da der Kondensatoren STS vom Boosterausgang gespiesen wird, entspricht dessen Spannung dem geregelten Boosterausgang. Für die Berechnung der Schwellwerte und der Kondensatoren ergibt sich:\\


  E_{Applikation}= C * \frac{1}{2} V_{STS}\ \

 
 $E_{Applikation}$ bezeichnet die  minimale 
 
Die Energiequelle, wie auch die angeschlossenen Speicher, haben eigene Pins, die ihren Zustand übermitteln (\cite{datasheet_EM85}, p.11).
