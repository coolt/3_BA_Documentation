...
Energy Management bezeichnet den Vorgang des Sammeln an Energie, dem Regeln von Spannung und Strom auf einen geforderten Schwellwert und die kontrollierte Freigabe. Zudem ist das Regeln des Inputs wesentlich, damit ein Optimum an Leistung aus einer Quelle bezogen werden kann \\


In der Bachelorarbeit ist das Verwenden des Chip EM8500 vorgegeben. 
\textbf{Alternative Powermanagementsysteme sind z. B. : Booster TI, Analog Devices, E-Beas.}


\subsection{Bauteile des Energiemanagements}
...
Dieser IC ist von EM Microelectronics aus Marin (NE) entwickelt. 
