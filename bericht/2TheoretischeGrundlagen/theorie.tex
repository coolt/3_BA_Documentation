...
\subsection{Booster}
Direkt mit dem MPP-Kontroller ist der Booster (siehe Blockdiagramm im Anhang \ref{anhang_em8500}). Die Aufgabe des Boosters ist es, das interne Spannungsniveau zu heben. EM8500 arbeitet ab einer Eingangsspannungen von 0.3 V, braucht aber zum vollständigen Betrieb des Chips eine Spannung von 1.8 V.\\

Da die beiden Kondensatoren STS und LTS vom Boosterausgang gespiesen werden, ist dessen Spannung für die Berechnung der gewonnenen Energie wichtig.
...
\begin{figure}    
    ...
    \caption{In- und Outputs EM8500}\label{IOEM8500} 
\end{figure}
