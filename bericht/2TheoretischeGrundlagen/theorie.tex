...
Diese Harvestingmethode produziert ein Gleichstrom, es braucht somit keinen Gleichrichter. Die Spannung am Ausgang ist konstant, da es sich um eine Stromquelle handelt (stimmt das ?).
...
Die produzierte Spannung ist vergleichsweise klein und bewegt sich im Bereich einiger 10 µV pro 1 °C Temperaturdifferenz. Erzeugt wird die Spannung am Ende zweier metallischer Leiter aus unterschiedlichem Material, die an einem Ende verbunden sind.(https://de.wikipedia.org/wiki/Thermoelement)\\


Diese Harvestingmethode produziert eine DC-Spannung und braucht keinen Gleichrichter. 
...
Diese Harvestingmethode produziert einen Wechselstrom. Ein Gleichrichter und einen Kondensator zur Glättung der Rippelspannung ist nach der Energiegewinnung notwendig.\\
...
Der grösste Unterschied besteht in der Art in der die Energie zur Verfügung steht. Die Solarzelle und ein TEG liefern Gleichstrom bzw. -spannung. Wodurch kein Gleichrichterschaltung und Glättung notwendig sind.\\


Der wesentliche Unterschied zwischen einer Solarzelle und einem TEG liegt in der Leistungkurve, dem Maximum Power Point.

Die Solarzelle hat ihr Maximum bei  a 80 \% un die elektrische Spannung bei maximaler Leistung (Maximum Power Point, Leistungsanpassung) liegt bei den gebräuchlichsten Zellen (kristalline Siliciumzellen) bei etwa 0,5 V. (Wikipedia.

Das TEG hat seine Leistungsmaximum bei 50 \% . 
(http://www.digikey.com/en/articles/techzone/2013/mar/maximizing-energy-harvesting-efficiency-from-thermal-sources, Maximizing Energy-Harvesting Efficiency from Thermal Sources, By Stephen Evanczuk, Contributed By Electronic Products, 2013-03-06)\\ 
Bild 1 Kurve\\

https://www.researchgate.net/publication/https://www.researchgate.net/publication/262154138_Maximum_Power_Point_Tracking_Converter_Based_on_the_Open-Circuit_Voltage_Method_for_Thermoelectric_Generators\\
Bild 3 Kurven\\

Bewegungsindktion bei ca. 50%
