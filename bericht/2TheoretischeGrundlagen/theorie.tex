...
\begin{equation} 
     E_{Applikation}= C_{STS} \times \frac{1}{2}\, (V_{STS\_HIGH} )^2 - C_{STS} \times \frac{1}{2}\, (V_{STS\_LOW} )^2
\end{equation}
...
Die Funktionsblöcke des TI-SensorTags befinden sich im Anhang \ref{anhang_TI-SensorTag}.
