...
In dieser Bachelorarbeit wird Energie über Bewegungsinduktion gewonnen. \glqq Befindet sich eine Spule in einem dynamischen Magnetfeld, wird in der Spule eine Spannung induziert\grqq \cite{PA_bicycle} S.8. Das dynamische Magnetfeld wird durch das Bewegen, oder im Fall eines Fahrrads einem Vorbeiziehen, eines Magneten an einer fix verankerten Spule erzeugt.
