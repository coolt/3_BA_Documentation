...
\begin{figure}
 \includegraphics{2TheoretischeGrundlagen/imag/MPPTEG.png}
\caption{MPP TEG}
\end{figure}
...
\begin{figure}
   \includegraphics{2TheoretischeGrundlagen/imag/MPPSolar.png}
   \caption{MPP Solarzelle}
\end{figure}


Bewegungsindktion bei ca. 50 \%
$http://www.electronicproducts.com/Power_Products/Batteries_and_Fuel_Cells/Energy_harvesting_from_an_ambient_electric_field.aspx$  -> Bild für eine Kurve
