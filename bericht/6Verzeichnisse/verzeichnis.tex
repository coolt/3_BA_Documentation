...
\textbf{MPPT-Ratio}\\
\forceindent Bezeichnet die Auswertung des MPP auf Spannungsachse. Liegt das Leistungmaximum beim Kurzschluss, so ist die MPPT-Ratio bei 0\thinspace\%, liegt sie bei Leerlauf, dann liegt die MPPT-Ratio bei 100\thinspace\%. Üblicherweise liegt die MPPT-Ratio dazwischen.
