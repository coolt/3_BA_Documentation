...
\todo{ Ziel der Entwicklung: Bei 10 km/h funktioniere, C Ausgang Harvester verbesern}
\todo { Kapitel: Schema, Bauteildefinition und Optimeirung, Layout}
...
\todo{Der Testteil entfällt. Ziel des Kapitels: Energiemessung und Optimierung ( da zu wenig Energie). Konkret: 2 Magnete, Reellight, besser Spule}
...
\todo{ Kapitelstrukur: Aubau der App, 
