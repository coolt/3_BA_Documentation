...
\begin{tabbing}
	...
	\caption{Leistung des fliegenden Aufbaus}
\end{tabbing}
...
\begin{tabbing}
	...
	\caption{Leistung der neuen Leiterplatte}
\end{tabbing}
...
Die maximal verfügbare Leistung konnte durch die stärkere Spule erneut drastisch verbessert werden. 
...
\begin{figure}[ht]
  ...
  \caption{rot: VCC_STS, gelb: VSUP}
\end{figure}EnergieEMChip15kmh
