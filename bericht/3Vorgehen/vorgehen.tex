...
\begin{tabbing}
    ...
    Senden BLE_Paket mit Sensordaten   \> 43 $\mu$J \\
\end{tabbing}
\end{minipage}
...
\begin{flalign}\label{eq:e-high-e-low}
  E_{Applikation} &= E_{Laden C} + E_{Init} + E_{Start Drucksensor} + E_{Senden BLE} \\\nonumber
       &= 63\, \mu J + 77\, \mu J + 6\, \mu J + 43\, \mu J = 189\, \mu J\nonumber
\end{flalign}

\begin{flalign}\label{eq:e_sts}
  C_{STS} &= \frac{2\times 189\, \mu J}{3^2 - (2.1)^2}\\
          &= \frac{ 378\, \mu J}{9 - 4.41}\\\nonumber
          &= \frac{ 378\, \mu J}{4.59}\\\nonumber
          &= 81.9\, \mu F
\end{flalign}
