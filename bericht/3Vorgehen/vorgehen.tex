...
\begin{itemize}
    \item tiefe Geschwindigkeit: 0 - 15 km/h
    \item mittlere Geschwindigkeit: 15 - 25 km/h 
    \item hohe Geschwindigkeit: grösser als 25 km/h 
\end{itemize}

\todo{finale Daten einesetzen}
\begin{table}[ht]
...
Der Energieverbrauch hängt von der Anzahl ausgelesener Daten ab (siehe Sensortag Energiemessungen \ref{v_messungen_sensortag}). Wird nur die Geschwindigkeit übermittelt, ist der Verbrauch kleiner, als wenn zusätzlich die Temperatur und die Höhe mitgesendet werden.
...
\subsubsection*{MPPT-Ratio bei 10 km/h gemäss Messprotokollen}
\begin{tabbing}
    Datum       \quad\= Leistungmaximum    \quad\= MPPT-Ratio\\[0.8ex]
    30. März    \> 12 $\mu$W        \> 43.23\thinspace\% \\
    xx          \> xx $\mu$W        \> xx\thinspace\%\\
    resultat    \> 21.87  $\mu$W    \> 24.87\thinspace\%\\
\end{tabbing}

Es zeigt sich, dass das Leistungsmaximum unterhalb von 50\thinspace\% liegt. Bedauerlich ist, dass durch die Energieoptimierung sich die Stelle des Leistungsmaximums Richtung Leerlauf verschob. In der Umsetzung mit dem EM8500-Chip ergibt sich das Problem, dass nur Konfigurationen von MPP_Rations von 50 - 80\thinspace\% erlaubt sind. Konkret lässt sich die Regelung auf folgende MPPT-Ratios (siehe untenstehende Tabell) einstellen. Die ersten Einstellungen sind somit gröber als die in der Höhe. Dies, weil der EM8500-Chip für Harvester vom Typ TEG und Solarzelle konzipiert ist und die MPPT-Ratio für diese zwei Anwendungen genau in diesem Range liegen.

\todo{MPPT-Ratio-Liste}
