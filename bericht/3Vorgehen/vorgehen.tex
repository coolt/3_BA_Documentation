...
Die Temperatur wird in zwei Bytes übertragen. jedoch wird die Temperatur nicht in °C übertragen, sondern in Tausendsteln. Das bedeutet die Temperatur, welche empfangen wird, muss zusammengesetzt und mit 1000 dividiert werden. Die Formel sieht folgendermassen aus:
...
\begin{figure}[ht]
    \includegraphics{3Vorgehen/imag/tachometer.bmp}
...
\begin{equation}
	x = \frac{Breite des Tachometers}{2} + Länge der Tachonadel * \cos(Winkel der Tachonadel)
\end{equation}

\begin{equation}
	y = \frac{Höhe des Tachometers}{2} + Länge der Tachonadel * \sin(Winkel der Tachonadel)
\end{equation}
