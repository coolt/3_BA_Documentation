...
Die Abbildung stammt aus dem Technical Manual des TI-SensorTags (\cite{Sensortag_Manual}, S.\,416). 
...
\subsection{Inbetriebnahme des Codes der Projektarbeit}
...
\captionof{table}{Filter für BLE-Pakete}
\begin{tabbing}
...
\begin{figure}[ht]
    \includegraphics[width=0.55\textwidth]{3Vorgehen/imag/app_saveAdress.png}
...
\begin{figure}[ht]
    \includegraphics[width=0.9\textwidth]{3Vorgehen/imag/app_checkAdress.png}
...
\begin{figure}[ht]
    \includegraphics[width=0.65\textwidth]{3Vorgehen/imag/app_tempSetting.png}
...
\begin{figure}[ht]
    \includegraphics[width=0.3\textwidth]{3Vorgehen/imag/tachometer.png}
...
\begin{figure}%[ht]
    \includegraphics[width=0.55\textwidth]{3Vorgehen/imag/app_getPixel.png}
...
\begin{figure}[ht]
    \includegraphics[width=0.9\textwidth]{3Vorgehen/imag/app_createBitmap.png}
...
\begin{figure}[ht]
    \includegraphics[width=1\textwidth]{3Vorgehen/imag/app_drawNeedle.png}
